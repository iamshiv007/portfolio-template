        ...
        <div>
            ...
            <div className='border border-gray-500  rounded-md'>
                <div className='p-2 border-b border-gray-500  flex gap-1'>
                    ...
                    {text_?.family !== undefined && <button className={`text-xs px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded-md`} style={{ fontFamily: fontFamilies[family] }} onClick={() => setText({ ...text_, family: text_?.family !== 4 ? family + 1 : 0 })}>Font</button>}
                </div>

...
export const PortfolioValuesProvider = ({ children }) => {
    ...
    const [image1, setImage1] = useState({ bottom: 0, right: 0, width: 350 });
    ...
    return (
        <portfolioValuesContext.Provider value={{ colorTheme, setColorTheme, portfolioFont, setPortfolioFont, isNavbarSelected, setIsNavbarSelected, isHomeSelected, setIsHomeSelected, navPaddingX, setNavPaddingX, navPaddingY, setNavPaddingY, logo, setLogo, menuIcon, setMenuIcon, gap1, setGap1, paddingX1, setPaddingX1, image1, setImage1, text1, setText1, text2, setText2, text3, setText3, animatedTexts, setAnimatedTexts }}>
            {children}
